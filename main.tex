...
% nologo - Removes the small logo from every slide's title bar
% sections - Shows the current section name under the slide title
% noslidenumbers - Removes counting of slides in bottom right
% fullFooter - Enables a more descriptive footer
% cornerlogo, mark=, logo=, textcolor= -- see README
\usetheme[sections,nav,fullFooter]{NotreDame}
